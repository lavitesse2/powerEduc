...
use local_powerschool\form\filiere;

require_once(__DIR__ . '/../../config.php');
require_once($CFG->dirroot.'/local/powerschool/classes/form/filiere.php');
...
$recordtoinsert = new filiere();
    ...
    if($fromform->id) {
        ...
        $recordtoinsert->update_filiere($fromform->id, $fromform->libellefiliere,$fromform->abbreviation );
