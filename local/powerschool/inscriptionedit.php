...
$recordtoinsert = new inscription();
    ...
    if($fromform->id) {
        ...
        $recordtoinsert->update_inscription($fromform->id, $fromform->numeroinscription,$fromform->idanneescolaire,$fromform->idcampus,$fromform->iduser,$fromform->idfiliere , $fromform->idcycle);
